...
| Quick Links              | <span class="fs-3">[Schedule](http://example.com/){: .btn }</span>&#160 <span class="fs-3">[Reading Groups](http://example.com/){: .btn }</span>&#160 <span class="fs-3">[Project Groups](http://example.com/){: .btn }</span>
